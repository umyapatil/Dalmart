...
import pulses from '../../assets/images/Categories/pulses.jpg';
import cereals from '../../assets/images/Categories/cereals.png';
import millets from '../../assets/images/Categories/millets.png';
import rices from '../../assets/images/Categories/rices.png';
                ...
                {catNav.map((item, i) => (
                    <Link to={`/products?category=${item.name}`} className="flex flex-col gap-1 items-center p-2 group" key={i}>
                        <div className="h-16 w-16">
                            <img draggable="false" className="h-full w-full object-contain rounded-full" src={item.icon} alt={item.name} />
                        </div>
